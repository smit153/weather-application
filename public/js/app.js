    ...
    .then((response) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          //   response.data.current.weather[i].main;
          ...
          clouds.innerHTML =
            "<b>Cloudiness:</b> " + response.data.current.clouds + "%";
          pop.innerHTML =
            "<b>visibility:</b> " +
            response.data.current.visibility / 1000 +
            "Km";
          ...
          if (
            ...
            if (today.getHours() < 19 && today.getHours() >= 7) {
              hd01 =
                "<img src='/img/animated/cloudy-day-" +
                a +
                ".svg'  id='icon'/>";
              icon.innerHTML = hd01;
            } else {
              hd01 =
                "<img src='/img/animated/cloudy-night-" +
                a +
                ".svg'  id='icon'/>";
              icon.innerHTML = hd01;
            }
          ...
          document.getElementById("heading4").innerHTML =
          ...
          document.getElementById("heading5").innerHTML =
            weekday[(d.getDay() + 5) % 7];
          document.getElementById("s5").innerHTML =
            ...
            "°C  " +
            response.data.daily[n++].weather[0].description;
          //console.log(response.data.daily[n].temp.max);
          function miniIcons(n) {
            if (Math.round(response.data.daily[n].weather[0].id % 100) == 2) {
              return (
                "<img src='/img/animated/rainy-" + a + ".svg'  id='icon1'/>"
              );
            }
            ...
            if (Math.round(response.data.daily[n].weather[0].id % 100) == 6)
              return (
                "<img src='/img/animated/snowy-" + a + ".svg'  id='icon1'/>"
              );
